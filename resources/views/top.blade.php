...
<meta name="description" content="サムライアグリは、果物をインターネットを利用し全国に販売を行う「SamuraiAgri」の運営を行っています。" />
...
<div id="container" class="clearfix">
	...
	<div id="wrapper" class="clearfix">
		...
		<div id="cont_side" class="dp_pc">
			<div id="side_ourservices" class="section">
...
<div id="footer">
	<div class="wrap clearfix">
		<ul class="clearfix dp_pc">
			<li><a href="/public/privacypolicy/">個人情報保護方針</a></li>
			<li class="sep">&nbsp;</li>
			<li><a href="mailto:good.kotan@gmail.com">お問い合わせ</a></li>
		</ul>
	</div><!--/.wrap-->
	<p id="copyrights">Copyright &copy; SAMURAI AGRI CO.,LTD All Rights Reserved.</p>
